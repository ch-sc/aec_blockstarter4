...
contract Voting {
    ...
    key = candidate name stored as type bytes32 
    value = unsigned integer which used to store the vote count
    */
    mapping (address => voter) public voterInfo;

    /** 
    Solidity doesn't let us return an array of strings yet. We will use an array of bytes32 instead to store the list of candidates
    */
    ...
    /**
    When the contract is deployed on the blockchain, we will initialize the total number of tokens for sale, cost per token and all the candidates
    */
    ...
    /**
    Instead of just taking the candidate name as an argument, we also require the no. of tokens this voter wants to vote for the candidate
    */
    ...
    /**
    function to purchase the tokens. Note the keyword 'payable' below, nowour contract can accept Ether from anyone who calls this function.
    */
